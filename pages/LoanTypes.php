                ...
                <div class="row">
                    <div class="col-lg-12">
                        <span style="color:#337AB7"><h1 class="page-header">Reference >
                            <small>
                                Loan Types <a class="btn btn-primary col-lg-offset-6 col-md-offset-2" href="LoanTypeView.php" ><i class="fa fa-table "></i> &nbsp &nbsp View &nbsp</a>
                            </small>
                        </h1></span>
                    </div>
                    <!-- /.col-lg-12 -->
...
if (isset($_POST['submit'])) {
	...
	$sql = "INSERT INTO Loan_Types(loan_code,description)
        VALUES ('".$_POST['loan_code']."','".$_POST['description']."') ";
...
mysqli_close($conn);
?>
                <form name="loanTypes" method="POST" action="LoanTypes.php" class="form-horizontal col-md-9 col-md-offset-2">
                    <fieldset>
                        <br/>

                        <div class="form-group">
                            <label style="font-weight:200" class="col-sm-4 control-label no-padding-right">Loan Code</label>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group">
                            ...
                            <br/>
                        <div>
                            <button type="submit" name="submit" value="submit" class="col-sm-offset-2 col-sm-4 btn btn-outline btn-md btn-success">Save</button>
