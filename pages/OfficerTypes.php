                ...
                <div class="row">
                    <div class="col-lg-12">
                        <span style="color:#337AB7"><h1 class="page-header">Reference >
                            <small>
                                Officer Types <a class="btn btn-primary col-lg-offset-4 col-md-offset-1" href="OfficerView.php" ><i class="fa fa-table "></i>  &nbsp &nbsp View &nbsp </a>
                            </small>
                        </h1></span>
                    </div>
                    <!-- /.col-lg-12 -->
...
if (isset($_POST['submit'])) {
	...
	$sql = "INSERT INTO Officer_Types(officer_code,description,status)
        VALUES ('" . $_POST['officer_code'] . "','" . $_POST['description'] . "','" . $_POST['status'] . "') ";
...
mysqli_close($conn);
?>
                <form method="POST" action="OfficerTypes.php" class="form-horizontal col-md-8 col-md-offset-2">
                    <fieldset>
                    <br/>
                        <div class="form-group">
                          <label style="font-weight:200" class="col-sm-3 control-label no-padding-right">Officer Code</label>
                          <div class="col-sm-5">
                        ...
                        <div class="form-group">
                          <label style="font-weight:200" class="col-sm-3 control-label no-padding-right">Description</label>
                          <div class="col-sm-5">
                        ...
                        <div class="form-group">
                          <label style="font-weight:200" class="col-sm-3 control-label no-padding-right">Status</label>
                          <div class="col-sm-5">
                        ...
                        <br/>
                        <div>
                            <button type="submit" name="submit" class="col-sm-offset-1 col-sm-4 btn btn-outline btn-md btn-success">Save</button>
