    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <span style="color:#337AB7"><h1 class="page-header">Administration >
                            <small>
                                User Registration <a class="btn btn-primary col-lg-offset-4 col-md-offset-1" href="UserView.php" ><i class="fa fa-table "></i> &nbsp &nbsp View &nbsp</a>
                            </small>
                        </h1></span>
<?php
require_once 'database.php';
...
?>
<div>
                            <form name="f1" method="POST" action="Register.php" class="form-horizontal col-md-8 col-md-offset-2">
                                <fieldset>
                                <br/>
                                    <div class="form-group">
                                      <label style="font-weight:200" class="col-sm-3 control-label no-padding-right">First Name</label>
                                      <div class="col-sm-5">
                                    ...
                                    <div class="form-group">
                                      <label style="font-weight:200" class="col-sm-3 control-label no-padding-right">Username</label>
                                      <div class="col-sm-5">
                                    ...
                                    <div class="form-group">
                                      <label style="font-weight:200" class="col-sm-3 control-label no-padding-right">Password</label>
                                      <div class="col-sm-5">
                                    ...
                                    <br/>
                                    <div>
                                        <button type="submit" class="col-sm-offset-1 col-sm-4 btn btn-outline btn-md btn-success">Register</button>
