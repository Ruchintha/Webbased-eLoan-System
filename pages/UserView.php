                ...
                <div class="row">
                    <div class="col-lg-12">
                        <span style="color:#337AB7"><h1 class="page-header">Administration >
                            <small>
                                Registered Users <a class="btn btn-primary col-lg-offset-4 col-md-offset-1" href="Register.php" ><i class="fa fa-sign-in "></i> Create new User </a>
                            </small>
                        </h1></span>
...
$sql    = "SELECT * FROM Login_users WHERE id != 5";
$result = mysqli_query($conn, $sql);

if (isset($_GET['submit'])) {
	$id  = $_GET['submit'];
	$sql = "DELETE FROM Login_users WHERE id='".$id."'";
...
while ($row = mysqli_fetch_array($result)) {
	?>
											     ...
											     <tr role="row">
										            ...
										            <td width="10%"><button type="submit" class="btn btn-sm btn-danger" value="<?php echo $row["id"]?>" name="submit">Delete</button> </td>
											     </tr>
											</tbody>
	<?php
}
