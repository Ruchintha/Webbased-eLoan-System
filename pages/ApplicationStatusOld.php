                ...
                <div class="row">
                    <div class="col-lg-12">
                        <span style="color:#337AB7"><h1 class="page-header">Reference >
                            <small>
                                Application Status <a class="btn btn-primary col-lg-offset-6 col-md-offset-2" href="applicationStatView.php" ><i class="fa fa-table "></i> &nbsp &nbsp View &nbsp</a>
                            </small>
                        </h1></span>
                    </div>
                    <!-- /.col-lg-12 -->
...
if (isset($_POST['submit'])) {
	...
	$sql = "INSERT INTO Application_Status(app_stat,description)
        VALUES ('".$_POST['app_stat']."','".$_POST['description']."') ";
...
mysqli_close($conn);
?>
                <form name="" method="POST" action="ApplicationStatus.php" class="form-horizontal col-md-9 col-md-offset-2">
                    <fieldset>
                        <br/>

                        <div class="form-group">
                            <label style="font-weight:200" class="col-sm-4 control-label no-padding-right">Application Status</label>
                            <div class="col-sm-4">
                                <input type="text" name="app_stat" class="form-control"  />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <br/>
                        <div>
                            <button type="submit" name="submit" value="submit" class="col-sm-offset-2 col-sm-3 btn btn-outline btn-md btn-success">Save</button>
