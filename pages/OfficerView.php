                ...
                <div class="row">
                    <div class="col-lg-12">
                        <span style="color:#337AB7"><h1 class="page-header">Reference >
                            <small>
                                Officer Types <a class="btn btn-primary col-lg-offset-4 col-md-offset-1" href="OfficerTypes.php" ><i class="fa fa-table "></i> &nbsp Create </a>
                            </small>
                        </h1></span>
                    </div>
                    <!-- /.col-lg-12 -->
...
while ($row = mysqli_fetch_array($result)) {
	?>
							           <tbody>
							                 <tr role="row">
							                   <td><?php echo $row['officer_code'];?></td>
