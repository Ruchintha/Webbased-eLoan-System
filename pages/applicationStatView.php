                ...
                <div class="row">
                    <div class="col-lg-12">
                        <span style="color:#337AB7"><h1 class="page-header">Reference >
                            <small>
                                Application Status <a class="btn btn-primary col-lg-offset-6 col-md-offset-2" href="applicationstatus.php" ><i class="fa  fa-arrow-left"></i> &nbsp &nbsp Back &nbsp</a>
                            </small>
                        </h1></span>
                    </div>
                    <!-- /.col-lg-12 -->
                ...
                <div class="col-sm-offset-2 col-sm-6">
                    <table role="grid" class="table table-striped table-bordered table-hover dataTable no-footer">
                        <thead style="color:#337AB7">
                            <tr role="row">
                            <th width="150px">Application Status</th>
                            <th>Description</th>
